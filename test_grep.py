...
def test_print_result_third(tmp_path, monkeypatch, capsys):
    monkeypatch.chdir(tmp_path)
    grep.print_result([None])
    out, err = capsys.readouterr()
    assert err == ''
    assert out == ''
...
def test_calculate_result():
    ...
    assert grep.calculate_result('a.txt', 'a', True, False, False, False,
                                 False, False, False, 2, ['abc']) == ['a.txt:abc']
    assert grep.calculate_result('', 'a', False, False, False, False, False,
                                 False, False, 0, ['abc']) == ['abc']
    assert grep.calculate_result('', 'a', False, True, False, False, False,
                                 False, False, 0, ['abc']) == ['1']
    assert grep.calculate_result('', 'a', True, True, False, False, False,
                                 False, False, 0, ['abc']) == ['1']
    assert grep.calculate_result('', 'a', True, False, False, False, False,
                                 False, False, 0, ['abc']) == ['abc']
    assert grep.calculate_result('a.txt', 'a', True, False, False, False, False,
                                 True, False, 2, ['a']) == ['a.txt']
    assert grep.calculate_result('a.txt', 'a', True, False, False, False, False,
                                 False, True, 2, ['b']) == ['a.txt']
    assert grep.calculate_result('a.txt', 'a', True, False, False, False, False,
                                 False, True, 2, ['a']) == [None]
